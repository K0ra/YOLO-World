...
base_lr = 1e-3
weight_decay = 0.0005
# load_from = '../weights/yolo_world_v2_x_obj365v1_goldg_cc3mlite_pretrain_1280ft-14996a36.pth'
load_from = 'C:/Users/Kora/Dev/Capstone/YOLO-World/weights/yolo_world_v2_x_obj365v1_goldg_cc3mlite_pretrain_1280ft-14996a36.pth'
...
ds_metainfo = {
    "classes": ("Bud-Sprouted", "Defected potato", "Diseased-fungal-damaged", "Good")
}

# dataset settings
coco_train_dataset = dict(type='YOLOv5CocoDataset',
                          data_root='potato_dataset/images/train',
                          ann_file='../../annotations/train_coco.json',
                          data_prefix=dict(img=''),
                          metainfo=ds_metainfo,
...
coco_val_dataset = dict(type='YOLOv5CocoDataset',
                        data_root='potato_dataset/images/val',
...
val_evaluator = dict(_delete_=True,
                     ...
                     ann_file='potato_dataset/annotations/val_coco.json',
                     metric='bbox')